...
\todo[inline]{Mögliche Typen anders/genauer definiert als von Funktionen (bsp geom)}
\todo[inline]{somit muss bei Benutzung beider endpunkte übersetzung stattfinden, außerdem können Queryables somit mehr Typinformationen enkodieren, als Funktionen annehmen können (beispiel funktion postgis die nur mit fläche sinn ergibt, aber die informationen können nicht umgesetzt werden)}
