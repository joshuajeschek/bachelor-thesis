...
\lstinputlisting[
  ...
  caption={Antwort auf \texttt{/queryables}-Anfrage für die Objektklasse "Gemeinde" im SimplexService (Auszug). Unter dem Schlüssel \texttt{properties} befinden sich alle Standardfelder und Attribute, die in der Klassendefinition angelegt wurden.},
  language=json,
  escapeinside=``
