...
alle \textit{collections} existieren. Jede \textit{collection} verfügt des Weiteren über einen
Unterpfad \texttt{/collections/\{collectionId\}/queryables}, welcher die spezifischen Attribute für
die \textit{collection} angibt.
\parencitealias{ogcFiltering}
...
\lstinputlisting[
  ...
  caption={\texttt{/queryables} für \textit{collection} "Gemeinden" (Auszug)},
  captionpos=b,
  language=json,
  escapeinside=``
