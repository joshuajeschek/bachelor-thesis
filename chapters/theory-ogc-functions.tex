\newcommand{\rfgfrjfn}{\footnote{\texttt{/req/functions/get-functions-response-json}
(\url{https://portal.ogc.org/files/96288\#req_functions_get-functions-response-json})}}
...
\lstinputlisting[
  label=lst:function,
  caption={\acs*{bnf} für \ac{cql}-Funktionen \parencitealiass{ogcFiltering}},
  firstnumber=351,
  firstline=351,
  lastline=363,
  language=bnf
...
\textcitealias{ogcFiltering} definiert Funktionen als eine Erweiterung für \ac{cql}, um komplexere
...
Datensätzen lassen sich jedoch mit Hilfe der Funktionen beliebig komplexe\todo{Beweis?} Ausdrücke
...
\citetitle{ogcFiltering} sieht für Argumente \texttt{type} als einzige Pflichtinformation vor\rfgfrjfn. Es
kann jedoch auch ein Titel und eine Beschreibung für Argumente definiert werden.
\parencitealias{ogcFiltering} Im SimplexService (siehe \ref{sec:simplex-service}) ist dies aktuell
