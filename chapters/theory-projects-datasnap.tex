...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{assets/snap-input-types.png}
...
\begin{figure}[!ht]
  ...
  \end{subfigure}
  \caption[Definition und Nutzung eines Blocks in \DataSnap{}]{Definition und Nutzung eines Blocks in \DataSnap{}, welcher das Alter einer Person aus einer \acs{CSV}-Datei aussucht, deren Spalten \texttt{Name} und \texttt{Age} sind. Der Block nimmt die parameter \texttt{name} und \texttt{csv\_url} an.\\\parencite[26]{hellmannDataSnapEnabling2015}}
\end{figure}
