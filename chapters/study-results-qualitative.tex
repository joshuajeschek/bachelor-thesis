...
\todo[inline]{auf RtL vs LtR eingehen?}
  ...
  \begin{tikzpicture}
    \begin{axis}[
        ...
        yticklabels={
            ...
            {\hyperref[p:mitte]{Benennung rechter Bereich (K)}},
...
\begin{figure}[!ht]
  ...
  \caption{Das Standardfeld \texttt{ndx} für 3 Objektklassen im dritten Szenario. Die Objektklasse "Adresse" ist Ausgangspunkt des Simplex-Szenarios und verfügt über keinen Präfix. Im Filtermenü (oben) wird diese Klasse als \textit{base} bezeichnet.}
