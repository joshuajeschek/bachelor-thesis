...
\begin{figure}[!ht]
  ...
  \caption{Nutzung der Funktion \texttt{concat} mit einer Überladung mit drei Parametern. Der angezeigte Tooltip lautet "nächste Überladung verwenden".}
  \label{fig:concat-overload}
  \endminipage
  \hfill
  \minipage[t]{.49\textwidth}
  \includegraphics[width=\linewidth]{assets/concat-nested.png}
  \caption{Eine geschachtelte Version der Funktion \texttt{concat}. Eine einfache Schachtelung resultiert in 3 nutzbare Eingabefelder.}
...
\begin{figure}
  ...
  \end{tikzpicture}
  \caption{Die im Block-Editor verwendeten Symbole für Datentypen. \\\parencitealias{bootstrapIcons}}
  \label{fig:icons}
\end{figure}
